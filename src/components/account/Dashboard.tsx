            ...
            <form onSubmit={handleSaveProfile} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5 md:col-span-2">
                  <label className="text-[10px] text-slate-500 font-bold uppercase block">Email Address (Read-Only)</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] text-slate-400 font-bold uppercase block">Phone Number</label>
                ...
                <div className="space-y-1.5 md:col-span-2">
                  <label className="text-[10px] text-slate-400 font-bold uppercase block">Street Address</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] text-slate-400 font-bold uppercase block">State</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] text-slate-400 font-bold uppercase block">Pincode</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] text-slate-400 font-bold uppercase block">B2B GSTIN (Optional)</label>
              ...
              <div className="flex gap-2 pt-2 border-t border-brand-border/40">
                <button type="button" onClick={() => setIsEditingProfile(false)} className="flex-1 py-2 text-xs font-bold uppercase rounded-lg border border-brand-border text-slate-400 hover:bg-slate-800">Cancel</button>
                <button type="submit" className="flex-1 py-2 text-xs font-bold uppercase rounded-lg bg-brand-orange text-black hover:bg-brand-gold flex justify-center items-center gap-1.5">
